...
class MapState(BaseState):
    def __init__(self, world, action_system, movement_system, free_actions_system, inventory_actions_system,
                 ...
                 render_ui_system, render_fps_counter_system, render_blit_system, basic_ai_system, map_input_system,
                 effects_system, essence_absorption_system, essence_drain_system, possession_system):
        systems = [
